...
def create_tires(body_length, body_width):
    ...
    arPolyNoise(fl_tire[0], 0.02)
    arPolyNoise(fr_tire[0], 0.02)
    arPolyNoise(rl_tire[0], 0.02)
    arPolyNoise(rr_tire[0], 0.02)
...
#geoObject = cmds.polySphere(radius=1, subdivisionsX=200, subdivisionsY=200)
